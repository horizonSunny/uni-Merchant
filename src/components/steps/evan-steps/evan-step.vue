<template>
  <view class="evan-step" :class="'evan-step--' + direction">
    <view
      ...
      :class="'evan-step__icon-wrapper--' + direction"
    >
      <slot name="icon"></slot>
    </view>
    <view
    ...
    >
      <uni-icons
        ...
        class="evan-step__custom-icon"
        :class="'evan-step__custom-icon--' + direction"
      ></uni-icons>
    </view>
    <view
      v-else
      class="evan-step__circle"
      :class="[
        'evan-step__circle--' + direction,
        'evan-step__circle--' + currentStatus
      ]"
      :style="{
    ...
    >
      ...
      ></uni-icons>
      <text
        class="evan-step__circle__text"
        :class="'evan-step__circle__text--' + currentStatus"
    ...
    <view
      class="evan-step__content"
      :class="'evan-step__content--' + direction"
      :style="{ height: contentHeight }"
    >
      <text
        ref="content"
        class="evan-step__content__title"
        :class="'evan-step__content__title--' + direction"
      ...
      <text
        ref="description"
        v-if="description"
        class="evan-step__content__description"
        :class="'evan-step__content__description--' + direction"
        :style="{ color: descriptionColor }"
        >{{ description }}</text
      >
    </view>
    <view
      class="evan-step__line"
      :class="'evan-step__line--' + direction"
      v-if="!isLast"
    >
      <view
        :class="'evan-step__line--' + direction + '__inner'"
...
<script>
import UniIcons from '@/components/steps/uni-icons/uni-icons.vue'
export default {
  name: 'EvanStep',
  components: {
    UniIcons
