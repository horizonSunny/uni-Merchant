import { route, baseConfig, Global } from './config.js.js'
import { builtIn } from '../vueRouter/base.js.js'
import { err, log } from './warn.js.js'
...
export const isObject = function(strObj) {
  return (
    strObj.toString() === '[object Object]' && strObj.constructor === Object
  )
}
/**
 * 获取当前运行平台
...
export const resolveRule = function(
  router,
  rule,
  query = {},
  ruleKey = 'path'
