// #ifdef H5
import { DOM } from '../component/h5-dom.js.js'

import { init } from '../vueRouter/init.js.js'
// #endif

import { warn } from '../helpers/warn.js.js'
...
class Patch {
  ...
  async setLoadingStatus({ loading, replaceStyle, resetStyle }) {
