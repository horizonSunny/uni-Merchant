...
import { parseQuery, formatURLQuery } from '../helpers/util.js.js'
import { vuelifeHooks, vueMount } from './base.js.js'

import { lifeCycle, Global } from '../helpers/config.js.js'
...
export const triggerLifeCycle = function(Router, vueRouter) {
  ...
  if (vueRouter.mode === 'hash') {
    ...
    let { toRoute, fromRoute } = getRouterNextInfo(currRoute, currRoute, Router)
